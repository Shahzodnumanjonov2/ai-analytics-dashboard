// app.js — ECharts dashboard (paging, exact count, LIVE)
(async function () {
  ...
  try { await load(); startRealtime(); startPolling(); }
  catch(e){ console.error(e); alert('Data load error: ' + (e?.message || e)); }
})();
